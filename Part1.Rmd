...
In this section we will illustrate different ways to visualize our data using two commonly used approaches namely Principal Component Analysis (PCA) and t-Distributed Stochastic Neighbor Embedding (tSNE). We will also use these techniques to illustrate what is the effect of selecting only a top fraction of overdispersed genes on data visualization. 
