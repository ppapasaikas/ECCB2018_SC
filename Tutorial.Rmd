...
cells_remove <- unique(c(filtered_cells,grep("A.r2",colnames(umi_counts))))
...
We'll fit a hurdle model, modeling the condition and cngeneson factor, thus adjusting for the cellular detection rate. In order to have more interpretable coefficients, we'll set the reference level of the factor to be the "C" cells.
