...
griph_res <- griph_cluster(as.matrix(clean_norm_umi_counts[endog,]), ClassAssignment=clean_anno[,4],plotG=FALSE,fsuffix='test')
plotLVis(griph_res, fill.type = "true", line.type = "predicted",seed=2357)
```
...
griph_res_batch <- griph_cluster(as.matrix(clean_norm_umi_counts[endog,]), BatchAssignment=clean_anno[,4], ClassAssignment=clean_anno[,1], batch.penalty=1,plotG=FALSE,fsuffix='test')
plotLVis(griph_res_batch, fill.type = "custom", line.type = "predicted",seed=2357, custom.class =clean_anno[,4] )
```
