...
#Run griph clustering specifying as batch the oroginating chip:
griph_res_batch <- griph_cluster(as.matrix(clean_norm_umi_counts[endog,]), ClassAssignment=clean_anno[,4],batch.penalty=1 ,plot=FALSE,rho=0.4)
